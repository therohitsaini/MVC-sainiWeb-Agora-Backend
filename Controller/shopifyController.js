...
const proxyShopifyConsultantDashboard = async (req, res) => {
    try {
        const shop = req.query.shop
        const themeId = req.query.theme_id;
        const cookieHeader = req.headers.cookie || "";
        ...
        const pageHtml = `
          ...
          <html>
            ...
            <body style="margin:0;padding:0;">
              ...
              <main style="min-height:70vh;">
                <iframe 
                  src="https://projectable-eely-minerva.ngrok-free.dev/consultant-dashboard" 
                  style="border:none;width:100%;height:100vh;display:block;"
                ></iframe>
              </main>
 ...
 * 2. React app ko same origin bundles se load karta hai (no iframe)
 */
const proxyShopifyConsultantCards = async (req, res) => {
    try {
        ...
        // Step 2: Customer registration (optional)
        ...
        // Step 3: React build ke bundles (current build se hardcoded paths)
        // NOTE: Agar naya build banate ho to filenames update karna padega
        const reactJsBundle = "/static/js/main.c42197bc.js";
        const reactCssBundle = "/static/css/main.cf6e1172.css";

        // Step 4: Combine Shopify header/footer with React app root div + bundles
        const combinedHtml = `
            <!DOCTYPE html>
            <html>
                <head>
                    ...
                    <link rel="stylesheet" href="${reactCssBundle}">
                    <script>
                        window.AGORA_CONFIG = {
                ...
                <body style="margin:0;padding:0;">
                    ...
                    ${footerHtml}
                    <script src="${reactJsBundle}"></script>
                </body>
            </html>
        `;
