    ...
    io.on("connection", (socket) => {
        ...
        socket.on("call-accepted", async ({ callerId, receiverId, channelName, callType, shopId }) => {
            try {
                ...
                if (callerSocketId) {
                    io.to(callerSocketId).emit("call-accepted-started", { callerId, receiverId, channelName, callType, transactionId: transaction._id, shopId });
                }
                if (receiverSocketId) {
                    io.to(receiverSocketId).emit("call-accepted-started", { callerId, receiverId, channelName, callType, transactionId: transaction._id, shopId });
                }
                ...
                console.log("consultant_____________isBusy", consultant.isBusy)
        ...
        socket.on("call-ended", async (data) => {
            ...
            try {
                ...
                await receiver.save();
                console.log("receiver_____________isBusy", receiver.isBusy)
